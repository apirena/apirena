...
export default {
  ...
  frameworks: [
    {
      path: "/Users/isaiahdahl/deployment/pinpath/libs/parser/tests/unit/flask/fixtures/basic_app",
      framework: "flask",
      confidence: 1,

      // Detection signals (debug mode)
      _signals: [
        { type: "requirements.txt", value: "flask dependency found", confidence: 0.8, source: "/Users/isaiahdahl/deployment/pinpath/libs/parser/tests/unit/flask/fixtures/basic_app/requirements.txt" },
        { type: "code_pattern", value: "Flask(__name__) or @app.route found", confidence: 0.9, source: "/Users/isaiahdahl/deployment/pinpath/libs/parser/tests/unit/flask/fixtures/basic_app/app.py" },
      ],
