...
<html>
<head>
    <title>Hallwatch Benchmark Report</title>
    <style>
...
<body>
    <div class="header">
        <h1>Hallwatch Benchmark Report</h1>
...
mod tests {
    ...
    fn test_summary_text_generation() {
        ...
        assert!(summary.contains("Hallwatch Benchmarks"));
    ...
    fn create_test_report() -> BenchmarkReport {
        BenchmarkReport {
            metadata: BenchmarkMetadata {
                ...
                hallwatch_version: "0.1.0".to_string(),
            },
            results: HashMap::new(),
