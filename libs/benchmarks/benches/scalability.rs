...
/// These validate that Hallwatch can handle enterprise-scale projects
...
async fn measure_large_project_performance(project_path: &std::path::Path) -> DetailedMetrics {
    ...
    DetailedMetrics {
        timing: hallwatch_benchmarks::metrics::TimingMetrics {
        ...
        memory: hallwatch_benchmarks::metrics::MemoryMetrics {
        ...
        throughput: hallwatch_benchmarks::metrics::ThroughputMetrics {
        ...
        quality: hallwatch_benchmarks::metrics::QualityMetrics {
